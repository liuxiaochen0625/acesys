<%@ page language="java" import="com.ascent.po.*" pageEncoding="gb2312"%>
...
<form name="form" action="" method="post">
 ...
 <s:else>
    ...
    <td><div align="center"><input type="checkbox" name="pid" value="<s:property value="id"/>" onclick="unselectAll(this.checked)"/></div></td>
    <td><div align="center"><s:property value="id"/></div></td>
