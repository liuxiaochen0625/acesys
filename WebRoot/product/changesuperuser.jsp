...
<%@ page language="java" import="java.util.*,com.ascent.po.*" pageEncoding="UTF-8"%>
...
<html>
  ...
  %>
		<FORM name="form" action="<%=request.getContextPath()%>/updatesuperuserusrManagerAction.action" method="post">
		<div class="head">
	<div id="login_1">
