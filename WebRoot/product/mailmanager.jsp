...
<html>
 ...
 function findEmail(){
   send_request("<%=request.getContextPath()%>/findMailManagerAction.action");
  } 
...
<div id="middlebody">
  ...
  <div id="xianshi"><a href="<%=request.getContextPath()%>/product/mailmanager.jsp#" onclick="findEmail()">已设邮箱</a></div><div id="email"></div>

  <p align="center">管理员邮箱设置</p>
<form name="form" method="post" action="addMailManagerAction.action">
  <div align="center">
