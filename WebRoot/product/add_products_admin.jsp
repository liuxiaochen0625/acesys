...
<script language="javascript">
	...
	//请求的地址
		var url="<%=request.getContextPath()%>/productIdCheckAction.action";
...
<div class="right_proaducts">我的位置&gt;&gt;电子商务管理&gt;&gt;商品添加</div>
	<table width="580">
      ...
      <tr>
        <td width="157" height="20" bgcolor="#B4E4FE" class="table_c">商品信息 &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:history.back()"><<< 返回</a></td>
        <td width="411"></td>
      </tr>
    </table>
	<table width="500" border="0" cellspacing="0" bordercolor="#9EA7AB" bgcolor="#DFEFFD">
	  ...
	  <td width="122"><input id="productId" name="productId" type="text"  onblur="checkId()"/>
	 ...
	 <tr>
	  ...
	  <td width="122"><input name="category" type="text" /></td>
	...
	<tr>
      ...
      <td height="45" colspan="4"><div align="center">
        ...
        <div class="loading_ll"><input type="image"  src="<%=request.getContextPath()%>/images/Add.jpg" onclick="return addproducts();"  border="0"/></div>
      </div></td>
	 </tr>
 </table>
</div>
