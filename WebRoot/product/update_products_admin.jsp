<%@ page language="java" import="java.util.*,com.ascent.po.*,com.ascent.util.*" pageEncoding="GB2312" %>
<html>
<head>
...
<body>
<form name="form" method="post" action="updateProductManagerAction.action" encType=multipart/form-data>
<div class="head">
	<div id="login_1"></div>
	<div id="login_2"></div>
	<div id="login_3"></div>
...
<div class="head">
 ...
 <%
	 ...
	 %>
<div class="table_t">|&nbsp;&nbsp;欢迎,<%=u.getUsername()%>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/clearSession.action" class="table_t">注销</a>&nbsp;&nbsp;|</div>
<div class="right_proaducts">我的位置&gt;&gt;电子商务管理&gt;&gt;商品修改 </div>
	<table width="580">
      ...
      <tr>
        ...
        <td width="411"> <input name="pid" type="hidden" value="<%=product.getId()%>" /></td>
      </tr>
    </table>
	<table width="500" border="0" cellspacing="0" bordercolor="#9EA7AB" bgcolor="#DFEFFD">
	 ...
	 <tr>
	  ...
	  <td width="122"><input name="catalogno" type="text" value="<%=product.getCategoryno()%>" /></td>
	 ...
	 <tr>
	  ...
	  <td width="122">
       <input name="mdlnumber" type="text" value="<%=product.getMdlint()%>"/></td>
	  <td width="85" class="table_c"><div align="right">新产品:</div></td>
	  <!-- td width="163" height="35">
	  <input name="newproduct" type="text" value="<%=product.getIsnewproduct() %>" /-->
	  <%
	  if(product.getIsnewproduct().equals("0")){
	  %>
	 ...
	 <%}if(product.getIsnewproduct().equals("1")){%>
	 ...
	 <tr>
	  ...
	  <td width="163" height="35"><input name="mw" type="text" value="<%=product.getWeight()%>" /></td>
  	 </tr>
	 <tr>
      <td width="122" height="22" class="table_c"><div align="right">Category:</div></td>
	  <td width="122"><input name="category" type="text" value="<%=product.getCategory()%>" /></td>
	  <td width="85" class="table_c"><div align="right">备注:</div></td>
	  <td width="163" height="30">
	  <% if(product.getNote()==null){%>
	  <input name="note" type="text" value=""/></td>
  	 <%}else{ %>
  	  <input name="note" type="text" value="<%=product.getNote()%>"/></td>
  	  <%}%>
  	 </tr> 
	<tr>
      <td width="122" height="22" class="table_c"><div align="right">价钱1:</div></td>
	  <td width="122">
      <input name="price1" type="text" value="<%=product.getPrice1()%>"/></td>
	  ...
	  <tr>
      <td width="122" height="30" class="table_c"><div align="right">价钱2:</div></td>
	  ...
	  <div class="img"><img src="<%=request.getContextPath()%>/upload/<%=product.getImagepath()%>" width="100" height="50" /></div>
      <!--  获取错误信息 -->
