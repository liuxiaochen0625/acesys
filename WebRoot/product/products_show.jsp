...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="mars">
 ...
 <s:else>
    ...
    <td><div align="center"><a href="#" onclick="return addshop(<s:property value="id"/>)">购买</a></div></td>
 ...
 %>   
       <form name="pageForm" action="guestPageShowProductManagerAction.action" method="post">         
