...
<div class="left_bj">
		...
		<div class="loading_p">欢迎您，<%=u.getUsername()%></div>
		<div class="loading_p">邮箱：<%=u.getEmail()%></div>
		<div class="loading_p"><a href="<%=request.getContextPath()%>/clearSession.action">注销</a></div>
...
<div class="p_wenzikuang">
  ...
  中间体服麻醉剂进入合理的价格和优良品质。 
  请参观<a href="<%=request.getContextPath()%>/product/guestPageShowProductManagerAction.action">浏览产品页</a>。
